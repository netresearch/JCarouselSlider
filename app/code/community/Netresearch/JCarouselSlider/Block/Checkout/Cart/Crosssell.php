...
class Netresearch_JCarouselSlider_Block_Checkout_Cart_Crosssell extends Mage_Checkout_Block_Cart_Crosssell
{
    /**
    ...
    */
    public function __construct() { 
        $this->jcCrosssell = new Netresearch_JCarouselSlider_Block_Summary('jccrossells');
        $this->_maxItemCount  = $this->jcCrosssell->getMaxItemCount();
    }
}